...
pub struct RouteTree {
    ...
    pub layout_chains: HashMap<String, Vec<String>>,        // build_cache()  Only for Page Nodes
    pub merged_metadata: HashMap<String, RouteMetadata>,    // build_cache()  Only for Page Nodes
}
